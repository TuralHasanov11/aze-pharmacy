...
class OrderSerializer(serializers.ModelSerializer):
    ...
    phone = serializers.RegexField(regex=r'^\+?1?\d{9,15}$', label=_('Phone'), error_messages={'required': _('Please enter your phone number'), 'regex': _('Please enter your phone in correct format')})
